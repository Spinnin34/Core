...
public class ConditionalEvents extends JavaPlugin {
	...
	public static String prefix = MessagesManager.getColoredMessage("&7[&c&lPMCORE&7] ");
	...
	public void onEnable(){
        ...
        Bukkit.getConsoleSender().sendMessage(MessagesManager.getColoredMessage(prefix+" &eGracias por usar mi plugin!   &fJorgePM"));
	...
	public void updateMessage(UpdateCheckerResult result){
		if(!result.isError()){
			...
			if(latestVersion != null){
				...
				Bukkit.getConsoleSender().sendMessage(MessagesManager.getColoredMessage("&cYou can download it at:"));
			}
		}else{
